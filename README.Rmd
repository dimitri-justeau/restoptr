...
Input data and preprocessed aggregated rasters can be accessed in `p$data`:

- `p$data$habitat_original` is the input, high resolution habitat raster.
- `p$data$existing_habitat` is the aggregated habitat raster.
- `p$data$restorable_habitat` is the aggregated restorable area raster.
